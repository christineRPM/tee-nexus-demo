...
async function main() {
  ...
  console.log(`🎯 Finding logo on SEPOLIA`);
  ...
  console.log(`🚀 Calling findLogo() on Sepolia...`);
  ...
  console.log(`🔗 View on Sepolia: https://sepolia.etherscan.io/address/${local.address}`);
  console.log(`🔗 View on Arbitrum Sepolia: https://sepolia.arbiscan.io/address/${remote.address}`);
}
